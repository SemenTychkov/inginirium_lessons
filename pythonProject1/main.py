...
plt.title('Joy Pldt of City and Highway Mileage by Class', fontsize=22)
plt.show()
...
def add_n_obs(df,group_col,y):
    ...
    for (x, xticklabel), n_ob in zip(enumerate(xticklabels), n_obs):
        plt.text(x, medians_dict[xticklabel]*1.01, "#abs : "+str(n_ob), horizontalalignment='center', fontdict={'size':14}, color="white")
